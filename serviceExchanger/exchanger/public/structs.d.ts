...
export declare type Balances = ReadonlyArray<Balance>;
...
export declare type ExtendedBalances = ReadonlyArray<ExtendedBalance>;
...
export declare const REBUILDING_ORDER_ID = "REBUILDING";
...
export declare type BalanceDivision = ReadonlyArray<AssetShare>;
