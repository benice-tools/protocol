...
export declare type PerDayBalanceDifference = ReadonlyArray<BalanceDifferenceWithTime>;
...
export declare type SharesWithChange = ReadonlyArray<AssetShareWithChange>;
